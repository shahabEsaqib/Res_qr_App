...
import 'package:res_qr_flutter/info/feedback.dart';
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Card(
                child: ListTile(
                  leading: Text('',style: TextStyle(fontSize: 22, fontWeight: FontWeight.w600,color: Colors.grey),),
                ),
              ),
              GestureDetector(
                onTap: (){
              ...
              Card(
                child: ListTile(
                  leading: Text('License',style: TextStyle(fontSize: 22, fontWeight: FontWeight.w600),),
                ),
              ),
              Card(
                child: ListTile(
              ...
              Card(
                child: ListTile(
                  leading: Text('Version 12.2',style: TextStyle(fontSize: 22, fontWeight: FontWeight.w600),),
                ),
              ),
