...
List<CatogryModel> multipleinjuries =[
  CatogryModel(
    ...
    description: 'This button will help you assess a victim with multiple or unknown injuries and prioritize treatment.\n(Press NEXT to continue.)',
    video : '',
     yes1 : '',
   no1 : '',
  yes1Des: '',
  ...
  CatogryModel(
    ...
    description: 'First, check to be certain the scene is safe and visually assess the area for any clues about the emergency.\n(Press NEXT to continue.)',
    video : '',
    yes1 : '',
    no1 : '',
    yes1Des: '',
  ...
  CatogryModel(
    ...
    description: 'Grab available first aid supplies and put on protective items such as safety gloves. Identify yourself and ask the victim for permission to provide care. If permission is refused, DO NOT proceed. Call 911 or your designated emergency number.\n(Press NEXT to continue.)',
    video : '',
    yes1 : '',
    no1 : '',
    yes1Des: '',
  ...
  CatogryModel(
    ...
    description: 'If victim is wearing a helmet, DO NOT remove it unless necessary to assess airway and you are trained to do so.\n(Press NEXT to continue.)',
    video : '',
    yes1 : '',
    no1 : '',
    yes1Des: '',
  ...
  CatogryModel(
    ...
    description: 'If the victim appears stable, press the Info button for a list of key questions to ask and document for hand off to EMTs when they arrive.  Gather whatever information you can from the victim, family members, or other bystanders until advanced care arrives.\n(Press NEXT to continue.)',
    video : '',
    yes1 : '',
    no1 : '',
    yes1Des: '',
  ...
  CatogryModel(
    ...
    description: 'Continually monitor the victim.  If at any time the victim loses consciousness or stops breathing, press the CPR button.  If the victim airway becomes obstructed or breathing constricted, press the Home icon and proceed with Breathing/Choking button. Forward past instructions already reviewed.\n(Press NEXT to continue.)',
    video : '',
    yes1 : '',
    no1 : '',
    yes1Des: '',
  ...
  CatogryModel(
    ...
    description: 'As soon as possible after the victim is treated and stabilized clean up any blood or body fluids left in the area using safety gloves. If a Bloodborne Pathogens Cleanup Kit is available, follow the instructions for use. When finished, wash hands.\n(Press NEXT to continue.)',
  ...
  CatogryModel(
    ...
    description: 'Press the Back or Next buttons to repeat any instructions or press the Start Over button to begin these instructions again.\n(END.)',
    video : '',
    yes1 : '',
    no1 : '',
    yes1Des: '',
...
List<CatogryModel> cpr =[
  CatogryModel(
    ...
    description: '''Tap the victim's shoulder or shout 'Are you okay?' CPR should only be performed if the victim is unconscious OR not breathing. If this does not describe the victim, press the button that most closely fits the emergency.\n(Press NEXT to continue and obtain more instructions for Adult, Child and Infant CPR.) ''',
    video: 'assets/videos/1-a.mp4',
    yes1 : '',
    no1 : '',
    yes1Des: '',
...
List<CatogryModel> Heart =[
  ...
  CatogryModel(
    ...
    description: 'Press the Back or Next buttons to repeat any instructions as necessary or press the Start Over button to begin these instructions again.\n(END)',
    yes1 : '',
    no1 : '',
    yes1Des: '',
    no1Des : '',
...
List<CatogryModel> bleeding =[
  CatogryModel(
    ...
    yes2Des: 'Press the arrow keys to repeat any instructions or press the Start Over button to begin these instructions again.\n(END)',
    no2: 'assets/sounds/BS10.6.mp3',
    no2Des: 'Press the arrow keys to repeat any instructions or press the Start Over button to begin these instructions again.\n(END)',
...
List<CatogryModel> burn =[
  CatogryModel(
    ...
    yes1Des: 'Press Back or Next buttons to repeat any instructions or press the Start Over button to begin these instructions again.\n(END)',
    no1: 'assets/sounds/CU1.0.mp3',
    no1Des: '''Tap the victim's shoulder or shout 'Are you okay?' CPR should only be performed if the victim is unconscious OR not breathing. If this does not describe the victim, press the button that most closely fits the emergency. \n(Press NEXT to continue.)''',
    video: 'assets/videos/1-a.mp4',
    yes2 : '',
...
List<CatogryModel> seizure =[
  CatogryModel(
    ...
    description: 'Press Back or Next buttons to repeat any instructions or press the Start Over button to begin these instructions again.\n(END)',
    video : '',
    yes1 : '',
    no1 : '',
    yes1Des: '',
...
List<CatogryModel> heat =[
  CatogryModel(
    ...
    yes1Des: 'Keep victim comfortable and seek appropriate medical care. Press the Back or Next buttons to repeat any instructions or press the Start Over button to begin these instructions again.\n(END)',
    no1: 'assets/sounds/CU1.0.mp3',
    no1Des: '''Tap the victim's shoulder or shout 'Are you okay?' CPR should only be performed if the victim is unconscious OR not breathing. If this does not describe the victim, press the button that most closely fits the emergency.\n(Press NEXT to continue.)''',
    video: 'assets/videos/1-a.mp4',
    yes2 : '',
...
List<CatogryModel> other =[
  CatogryModel(
    ...
    yes1Des: 'Press the Back or Next buttons to repeat any instructions or press the Start Over button to begin these instructions again.\n(END)',
    no1: 'assets/sounds/CU1.0.mp3',
    no1Des: '''Tap the victim's shoulder or shout 'Are you okay?' CPR should only be performed if the victim is unconscious OR not breathing. If this does not describe the victim, press the button that most closely fits the emergency.\n(Press NEXT to continue.)''',
    video: 'assets/videos/1-a.mp4',
    yes2 : '',
